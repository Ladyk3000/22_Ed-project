...
with DAG(dag_id=DAG_ID,
    ...
    load_gdrive_customer_task = PythonOperator(dag=dag,
                                            task_id=f"{DAG_ID}.RAW.{customer_table_name}",
    ...
    #start_task >> [load_customer_raw_task,] >> customer_totals_datamart_task >> end_task
    start_task >> load_gdrive_customer_task >> customer_totals_datamart_task >> end_task
